...
!
!! svn $Id: ana_nudgcoef.h 645 2013-01-22 23:21:54Z arango $
!!================================================= Hernan G. Arango ===
...
#elif defined ARCTIC20KM || defined NORDIC4KM || defined NORKYST800M || defined NORSEAS800M || defined NORFJORDS
!
      cff1=1.0_r8/(5.0_r8*86400.0_r8)
      cff2=0.0_r8
      Iwrk=15                ! HERE IS THE WIDTH OF THE NUDGING ZONE DEFINED!!!
      DO j=JstrR,JendR
        DO i=IstrR,IendR
          wrk(i,j)=cff2
        END DO
